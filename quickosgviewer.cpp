...
//    setScene(osgDB::readNodeFile("E:/BaiduNetdiskDownload/offline/offline.earth"));
...
{
    qDebug() << "QQuickFramebufferObject::Renderer * QuickOSGViewer::createRenderer() const";
...
{
    qDebug() << "QuickOSGViewer::setClearColor";
...
{
    qDebug() << "void QuickOSGViewer::geometryChanged";
...
//    qDebug() << "retinaScale:" << retinaScale << " m_mouseX:" << m_mouseX << " m_mouseY:" << m_mouseY;
    switch (event->button())
    {
    case Qt::LeftButton:
        m_mouseBtn = 1;
...
{
    qDebug() << "QuickOSGViewer::setScene";
    if (m_sceneNode == node)
        return;
    m_sceneNode = node;
...
void QuickOSGViewer::setDefaultFbo(QOpenGLFramebufferObject *newDefaultFbo)
{
    qDebug() << "QuickOSGViewer::setDefaultFbo";
    if(m_defaultFbo == newDefaultFbo)
        return;
...
{
    qDebug() << "void QuickOSGViewer::addChild";
...
{
    qDebug() << "osg::Node* QuickOSGViewer::getNode(QString& name)";
